...
// Department → stages mapping (for admin filter)
const DEPT_STAGES = {
  all: [],
  sales: ["Quotation"],
  registration: ["Registration", "Net Metering Filed"],
  finance: ["Finance Clearance"],
  warehouse: ["Structure Dispatch", "Kit Dispatched"],
  field: ["Structure Installed", "Kit Installed"],
  qa: ["QA Inspected"],
