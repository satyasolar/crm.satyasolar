...
const pipelineStages = [
  { key: "Sales", label: "Confirmed", dept: "sales" },
  { key: "Registration", label: "Registered", dept: "registration" },
  { key: "Warehouse", label: "Inventory", dept: "warehouse" },
  { key: "Project Phase 2", label: "Installed", dept: "project" },
  { key: "Electrical", label: "Net Metering", dept: "electrical" },
  { key: "Quality Assurance", label: "QA Check", dept: "quality" },
  { key: "Accounts", label: "Payment", dept: "accounts" },
  { key: "Subsidy", label: "Subsidy", dept: "subsidy" },
  { key: "Project Closed", label: "Completed", dept: "admin" },
];
...
const stageToTeam: Record<string, string> = {
  ...
  "Accounts": "Accounts",
  "Subsidy": "Subsidy",
  "Customer Service / AMC": "Customer Service",
...
const stageToAllowedRole: Record<string, string[]> = {
  ...
  "Banking & Finance": ["banking", "finance", "admin"],
  "Project Phase 1": ["project", "admin", "operations"],
  "Warehouse": ["warehouse", "inventory", "admin"],
  "Project Phase 2": ["project", "field", "admin", "operations"],
  "Electrical": ["electrical", "net_metering", "admin"],
  "Project Phase 3": ["project", "admin", "operations"],
  "Quality Assurance": ["quality", "admin"],
  "Accounts": ["accounts", "finance", "admin"],
  "Subsidy": ["subsidy", "admin"],
  "Customer Service / AMC": ["customer_service", "admin"],
  "Project Closed": ["admin"],
};
  ...
  try {
    ...
    if (action === "dept_overview") {
      ...
      const stagesByRole: Record<string, string[]> = {
        sales: ["Sales", "Case Confirmed"],
        registration: ["Registration", "Registration Done", "Registration Pending", "Registration Approved", "Registration: Document Verification", "Registration: Government Portal", "Registration: Payment Verification"],
        banking: ["Banking & Finance", "Bank & Finance"],
        warehouse: ["Warehouse", "Warehouse: Material Dispatch"],
        inventory: ["Sent to Store", "Warehouse", "Warehouse: Material Dispatch"],
        project: ["Project Phase 1", "Project Phase 2", "Project Phase 3", "Project: Survey & Design", "Project: Installation"],
        field_installation: ["Installation Done", "Plant Activated", "Project Phase 2", "Project Phase 3"],
        electrical: ["Electrical", "Electrical: Net Metering"],
        net_metering: ["Electrical", "Electrical: Net Metering"],
        quality: ["Quality Assurance"],
        qa: ["Quality Assurance"],
        accounts: ["Accounts", "Accounts: Payment Clearance"],
        subsidy: ["Subsidy", "Subsidy Registration Completed"],
        customer_service: ["Customer Service / AMC", "Customer Service Update"],
      };
