...
const pipelineStages = [
  ...
  {
    key: "Installation Done",
    label: "Installation",
    dept: "field_installation",
  },
  ...
  { key: "Completed", label: "Completed", dept: "admin" },
];
...
const stageToAllowedRole: Record<string, string[]> = {
  ...
  "Installation Done": ["field_installation", "admin"],
          ...
          (quotes || []).map(async (q: any) => {
            ...
            if (q.case_id || q.linked_case_id) {
              const { data: c } = await supabase
                .from("cases")
                .select(
                  "case_id, tracking_id, current_stage, status, customer_name, created_at",
                )
            ...
            return {
              ...
              currentStage:
                ...
                (q.status === "Approved" ? "Registration Done" : "Sales"),
